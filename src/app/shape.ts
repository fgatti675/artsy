...
export class Shape extends Mesh {
  constructor() {
    super();
    this.geometry = new SphereBufferGeometry(5,
      50,
      50,
    );

    this.material = new MeshPhongMaterial({});
    this.material.userData.delta = {value: 0};
...
#include <uv_vertex>
  ...
  float displacement = pnoise(s * normal + r, vec3( 10.0, 10.0, 10.0 ) ) + 1.0;
